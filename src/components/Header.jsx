...
function Header() {
  ...
  return (
    <>
      <header className="flex justify-between items-center relative py-3.6 px-7.5 max-w-wrapper m-auto md2:px-12.5 lg2:py-5 font-work__sans">
        <Link to="/">
        ...
        <div
          className={`flex absolute top-full flex-col w-full left-0 items-center bg-bag transition-all duration-300 ease-initial lg2:relative lg2:flex-row lg2:w-fit  ${
        ...
        >
          <ul className="flex flex-col w-full items-center lg2:flex-row lg2:w-fit lg2:mr-2.5 lg2:gap-2.5">
            <li>
              <NavLink
                ...
                to="/marketplace"
                className="block py-3 px-5 text-base leading-140 font-semibold text-white"
              >
          ...
          <Link
            onClick={() => setshow(!show)}
            to="/signin"
            className="flex py-5 px-7.5 w-fit bg-action text-white justify-center gap-3 items-center text-base leading-140 font-semibold rounded-20"
          >
            <div>
              <svg
                width="20"
